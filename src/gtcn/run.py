...
train_model(
    params=regular_best_params,
    training_set_path=regular_training_set_path,
    model_path="./src/gtcn/datasets/model.pth",
    epochs=300,
)
...
train_model(
    params=shift5_best_params,
    training_set_path=shift5_training_set_path,
